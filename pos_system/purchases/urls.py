...
urlpatterns = [
    ...
    path('add-order-items/<int:pk>/', views.PurchaseOrderItemsFormView.as_view(), name='p_order_items_form_view'),
    path('delete-order-items/<int:pk>/', views.DeletePurchaseOrderItemsView.as_view(), name='delete_p_order_items_view'),
]
